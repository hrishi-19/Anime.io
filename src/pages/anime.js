...
export default function AnimePage() {
    ...
    return (
        <>  <div className="flex ml-2 px-2 py-2 mt-14">
            ...
            <div className="w-full  relative top-20 px-2  sm:px-6 py-5">
                ...
                <div className="w-full pt-6 flex-col sm:flex-row flex items-center justify-between">
                    <div className="p-2 w-full sm:w-2/6 flex items-center justify-center">
                            <img src={animeDetails.image_url} loading="lazy"/>
                    </div>
                    <div className="p-3 w-full sm:w-3/6 text-slate-500 font-semibold text-md sm:text-2xl leading-10 tracking-wide ">
                        ...
                        <p className="w-full pt-6">Release Date: {animeDetails.release_date}</p>
                        <p className="w-full pt-6">Episodes: {animeDetails.episodes}</p>
                        <p className="w-full pt-6">Rank: {animeDetails.rank}</p>
                        <p className="w-full pt-6">Rating: {animeDetails.rating}</p>
